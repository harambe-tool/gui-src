...
function HARBase(props) {
  return (
    <>
      <div style={{overflowY:"scroll", overflowWrap:"break-word", width:"250px", height:"300px", borderRadius:"12px", background:`rgba(255,255,255,${props.selected ? 0.2 : 0.1})`, padding:"10px", border:`2px solid rgba(134, 124, 255, ${props.selected ? 1 : 0} )` }}>
