    ...
    <div onDragEnd={e=>{dragHandle(e,false)}} onDragOver={e=>{dragHandle(e,true)}} onDragLeave={e=>{dragHandle(e,false)}} style={{height:"100vh"}}>
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", height: "100vh" }}>
          ...
          <div>
            ...
            { file && <button onClick={()=>handleUpload()} style={{ borderRadius: "5px", padding: "10px", border: "1px solid var(--onBackground)", margin:"50px", background:"rgba(255, 255, 255, 0.05)", cursor: "pointer"}}>
              Get Started
            </button>}
            <button onClick={()=>navigate('/settings')} className="settings-button"><MdSettings></MdSettings> <span>Settings</span></button>
        </div>
    </div>
    </>
  );
